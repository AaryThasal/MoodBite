...
function MoodSelector({ onConfirm, locationName = null }) {
    ...
    const styles = {
        ...
        card: {
            ...
            boxShadow: '0 8px 24px -8px rgba(62, 39, 35, 0.08)',
            cursor: 'pointer',
        ...
        confirmBox: {
            ...
            padding: '24px 32px',
            boxShadow: '0 -8px 30px -10px rgba(62, 39, 35, 0.15)',
            display: 'flex',
            flexDirection: 'row',
            alignItems: 'center',
            justifyContent: 'center',
        ...
        badge: {
            ...
            backgroundColor: '#FFFBF5',
            borderRadius: '9999px',
            boxShadow: '0 4px 20px -4px rgba(62, 39, 35, 0.1)',
            border: '1px solid #E8D5C4'
        }
    };
                ...
                {locationName && (
                    <div style={styles.locationBadge}>
                        <div style={styles.badge}>
                            ...
                            <span style={{ color: '#8B7355', fontWeight: '500' }}>{locationName}</span>
                        </div>
                    </div>
                )}
